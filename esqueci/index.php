...
// SEO
$seo_subtitle = "Esqueci minha senha! - BR Delivery Sitemas de lojas online.";
$seo_description = "BR Delivery Sitema multilojas de lojas online.";
$seo_keywords = "BR Delivery, Script multilojas, sistema de lojas virtuais, loja virtual gratis, ecommerce, loja delivery, pedido no whatsapp, franquia de delivery, franquia de sistemas multilojas, script delivery multilojas";
// HEADER
$system_header = "";
...
if( $formdata ) {
  ...
  $msg .= "Atenciosamente BR Delivery";
												...
												<div class="row">
													...
													<div class="col-md-12">
														...
														<div class="brand brand-login text-center">
															<img src="<?php just_url(); ?>/_core/_cdn/img/logoo.png"/>
														</div>
