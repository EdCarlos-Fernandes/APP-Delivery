...
// SEO
$seo_subtitle = "Login! - BR Delivery Sitema de lojas online.";
$seo_description = "BR Delivery Sitema de lojas online.";
$seo_keywords = "BR Delivery, multilojas, sistema de lojas virtuais, loja virtual gratis, ecommerce, loja delivery, pedido no whatsapp, franquia de delivery, franquia de sistemas multilojas, script delivery multilojas";
// HEADER
$system_header = "";
// CHECK LOGGED
