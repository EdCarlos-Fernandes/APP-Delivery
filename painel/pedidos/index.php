...
restrict_expirado();
// SEO
$seo_subtitle = "Gestão de Pedidos! - BR delivery Sitema multilojas de lojas online.";
$seo_description = "BR delicery Sitema de lojas online.";
$seo_keywords = "BRdelivery, BR delivery, Script multilojas, sistema de lojas virtuais, loja virtual gratis, ecommerce, loja delivery, pedido no whatsapp, franquia de delivery, franquia de sistemas multilojas, script delivery multilojas";
// HEADER
$system_header .= "";
...
$msg4="Olá, ".strtoupper($nome)."\n";
$msg4.="\n";
$msg4.="*Seu pedido saiu para entrega*\n";
$msg4;
$text4 = urlencode($msg4);
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
                                    	...
                                    	<?php if( $data['status'] == "4" ) { ?>
                                    		<span class="badge" style="background-color:#009900">Pedido aceito</span>
                                    	<?php } ?>
                                    	<?php if( $data['status'] == "5" ) { ?>
                                    		<span class="badge" style="background-color:#003399">Saiu para Entrega</span>
                                    	<?php } ?>
                                    	<?php if( $data['status'] == "6" ) { ?>
                                    		<span class="badge" style="background-color:#003399">Disponível p/ Retirada</span>
                                    	<?php } ?>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
										    <a class="color-green" href = "<?php panel_url(); ?>/pedidos/aceitar/?id=<?php echo $data['id']; ?>&nome=<?php echo $data['nome']; ?>&whats=<?php echo $data['whatsapp']; ?>" title="Aceitar"><i class="lni lni-checkmark" style="transform: scale(1.3);"></i></a>
											
											
											<a target="_blank" class="color-white" href="<?php panel_url(); ?>/pedidos/imprimir?id=<?php echo $data['id']; ?>" title="Imprimir"><i class="lni lni-printer" style="transform: scale(1.3);"></i></a>
											<a class="color-yellow" href="<?php panel_url(); ?>/pedidos/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-magnifier" style="transform: scale(1.3);"></i></a>
										    <a class="color-white" href = "<?php panel_url(); ?>/pedidos/retirada/?id=<?php echo $data['id']; ?>&nome=<?php echo $data['nome']; ?>&whats=<?php echo $data['whatsapp']; ?>" title="Disponível p/ Retirada"><i class="lni lni-exit" style="transform: scale(1.3);"></i></a>
											<a class="color-white" href = "<?php panel_url(); ?>/pedidos/disponivel/?id=<?php echo $data['id']; ?>&nome=<?php echo $data['nome']; ?>&whats=<?php echo $data['whatsapp']; ?>" title="Saiu para entrega"><i class="lni lni-bi-cycle" style="transform: scale(1.3);"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a class="color-white" href = "<?php panel_url(); ?>/pedidos/concluir/?id=<?php echo $data['id']; ?>&nome=<?php echo $data['nome']; ?>&whats=<?php echo $data['whatsapp']; ?>" title="Concluir Pedido"><i class="lni lni-pointer-right" style="transform: scale(1.3);"></i></a>
										    <a class="color-red" onclick="if(confirm('Tem certeza que deseja cancelar este pedido?')) document.location = '<?php panel_url(); ?>/pedidos/cancelar/?id=<?php echo $data['id']; ?>'" href="#" title="Cancelar"><i class="lni lni-trash" style="transform: scale(1.3);"></i></a>
											<!-- <a class="color-red" onclick="if(confirm('Tem certeza que deseja cancelar este pedido?')) document.location = '<?php panel_url(); ?>/pedidos/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash" style="transform: scale(1.3);"></i></a> -->
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
