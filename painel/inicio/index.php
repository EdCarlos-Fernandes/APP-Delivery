...
// Globals
  ...
  // total de pedidos
  $mesatuall = date("m");
  $querypedidos = mysqli_query( $db_con, "SELECT id FROM pedidos WHERE MONTH(data_hora) = '$mesatuall' AND rel_estabelecimentos_id = '$id'");
	...
	<div class="container">
				...
				<div id="collapse-avisos" class="panel-collapse collapse <?php if( $expiracao < 3 ) { echo "in"; }; ?>">
					<div class="panel-body panel-body-pendentes">
						<div class="expiration-info">
							<div class="row">
								<div class="col-md-12"> <!--   original -> col-md-9   -->
		...
		<div class="lista-menus">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="lista-menus-menu lista-menus-nocounter">
						<a class="bt" href="https://wa.me/5511910276204" target="_blank">
