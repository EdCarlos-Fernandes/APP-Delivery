			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="mini-links pull-right">
						<a target="_blank" href="https://api.whatsapp.com/send?phone=5511910276204&text=Olá, preciso de ajuda!"><i class="lni lni-headphone-alt"></i> Fale conosco</a>
		...
		<div class="container">
				...
				<div class="col-md-3">
					...
					<div class="brand-cidade">
						<a href="<?php echo $app['url']; ?>">
							<img src="<?php echo $app['url']; ?>/_core/_cdn/img/logoo.png"/>
						</a>
					</div>
			...
			<div class="row align-middle-mobile visible-sm visible-xs">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 nopadd">
					...
					<div class="brand-cidade">
						<a href="<?php echo $app['url']; ?>">
							<img src="<?php echo $app['url']; ?>/_core/_cdn/img/logowhitee.png"/>
						</a>
					</div>
