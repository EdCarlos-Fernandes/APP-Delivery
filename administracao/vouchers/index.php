...
restrict('1');
// SEO
$seo_subtitle = "Vouchers! - LF Cardapio! Sitema multilojas de lojas online.";
$seo_description = "LF Cardapio! Sitema multilojas de lojas online.";
$seo_keywords = "LF Cardapio, Script multilojas, sistema de lojas virtuais, loja virtual gratis, ecommerce, loja delivery, pedido no whatsapp, franquia de delivery, franquia de sistemas multilojas, delivery multilojas";
// HEADER
$system_header .= "";
