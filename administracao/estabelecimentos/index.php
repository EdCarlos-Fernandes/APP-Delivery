				...
				<div class="col-md-12">
					...
					<table class="listing-table fake-table clean-table">
						<thead>
							...
							<th class="hidden-xs hidden-sm">Afiliado</th>
							<th></th>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td class="hidden-xs hidden-sm">
									...
									<td class="hidden-xs hidden-sm">
                                    <span class="fake-table-title hidden-xs hidden-sm">Afiliados</span>
                                    <?php
                                    $user = CheckUser($data['afiliado']);
                                    $userdata = CheckUserInfo($data['afiliado']);
                                    $email = (!empty($user['email']) ? $user['email'] : 'Não informado');
                                    $cell = (!empty($userdata['telefone']) ? $userdata['telefone'] : 'Não informado');
                    
                                    $documento = (!empty($userdata['documento']) ? $userdata['documento'] : 'Não informado');
                                    ?>
                                    <div class="fake-table-data"><?= (!empty($user['nome']) ? "<b style='cursor:pointer' id='{$data['afiliado']}'>". $user['nome'] ."</b>" : 'Não Informado'); ?></div>
                                    <div class="fake-table-break"></div>
                                    ...
                                    <script>
                                        $(function(){
                                            ...
                                            $('#<?= $data['afiliado'];?>').click(function(){
                                                alert('ID: <?= $data['afiliado'];?>\n ________________________________\nNome: <?=  $user['nome'];?>\n ________________________________\nEmail: <?= $email ;?>\n ________________________________\nContato: <?= $cell ;?>\n ________________________________\nDocumento: <?= $documento ;?>');
                                            })
                                        });
                                    </script>
								</td>
