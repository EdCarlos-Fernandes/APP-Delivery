  ...
  if( $formdata ) {
    ...
    // Setar campos
      ...
      // Entrega
        $latitude = '';
        $longitude = '';
        if(empty($dataestabelecimento['latitude']) || empty($dataestabelecimento['longitude'])):
        $latitude = mysqli_real_escape_string( $db_con, $_POST['latitude'] );
        $longitude = mysqli_real_escape_string( $db_con, $_POST['longitude'] );
        endif;
        ...
        //CUSTOM BY MDP LTDA | PIETRO NAPOLEÃO
		$taxa_padrao = dinheiro( mysqli_real_escape_string( $db_con, $_POST['taxa_padrao'] ) );
        if( !$taxa_padrao ) {
          $taxa_padrao = "0.00";
        }
        
          $limit_km = mysqli_real_escape_string( $db_con, $_POST['limit_km'] );
		  if( !$limit_km ) {
          $limit_km = 10;
        }
				...
				<div class="row elemento-pagamento-pix <?php if( $dataestabelecimento['pagamento_pix'] == "2" ){ echo 'elemento-oculto'; }; ?>">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
						...
						<span class="form-tip">CELULAR - Ex: DDDNUMERO onde 82988846334</span>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-field-default">
                          ...
                          <label>Taxa de Entrega(valor minimo cobrado)</label>
                          <input type="text" name="taxa_padrao" value="<?php echo htmlclean( dinheiro( $dataestabelecimento['taxa_padrao'], "BR") ); ?>">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-field-default">
                          ...
                          <label>Distância Máxima(Limite de entregas. Ex: 10 =  10 Km)</label>
                          <input type="text" name="limit_km" value="<?php echo htmlclean( $dataestabelecimento['limit_km'] ); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      ...
                      <div class="form-field-default">
                          ...
                          <input type="text" name="latitude" value="<?= ($dataestabelecimento['latitude'] ? $dataestabelecimento['latitude'] : $_SESSION['geolocation']['latitude']);?>">
                         </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      ...
                      <input type="text" name="longitude" value="<?= ($dataestabelecimento['longitude'] ? $dataestabelecimento['longitude'] : $_SESSION['geolocation']['longitude']);?>">
                      </div>
...
<?php if($_GET['msg']):
    echo"<script> setTimeout(function () {
        $('#modalalerta').fadeOut(); window.location.href='https://mpedidos.com/painel/configuracoes';},2000);
</script>";
endif;
?>
