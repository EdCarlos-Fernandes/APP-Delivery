...
<?php
  ...
  if( $formdata ) {
    ...
    $tipo_taxa = mysqli_real_escape_string($db_con, $_POST['tipo_taxa']);
    ...
    if( !$checkerrors ) {
      ...
      if( new_frete( $estabelecimento,$nome,$valor,$tipo_taxa ) ) {
          ...
          <div class="row">
           ...
           <div class="col-md-6">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Qual o tipo de taxa para esse Bairro?</label>
                        <div class="form-field-radio">
                          <input type="radio" name="tipo_taxa" value="0" <?php if($_POST['tipo_taxa'] == 0 OR !$_POST['tipo_taxa'] ){ echo 'checked'; }; ?>>Taxa Fixa
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="tipo_taxa" value="1" <?php if( $_POST['tipo_taxa'] == 1 ){ echo 'checked'; }; ?>>Cálculo por KM(Valor * km)
                        </div>
                        <div class="clear"></div>
