		...
		<div class="listing">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-6">
					<span class="listing-title"><strong class="counter"><?php echo $total_results_full; ?></strong> Taxas Adicionais:</span>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6">
					...
					<table class="listing-table normal-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    <span class="fake-table-title">Calculo</span>
                                    <div class="fake-table-data"><?= (!empty($data['tipo_taxa']) ? 'Taxa calculo/Km' : 'Taxa Fixa'); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td>
