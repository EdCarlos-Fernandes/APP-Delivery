...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_frete( $id,$nome,$valor,$tipo_taxa) ) {
            ...
            <div class="col-md-6">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="tipo_taxa" value="0" <?php if( $data['tipo_taxa'] == 0 OR !$data['tipo_taxa'] ){ echo 'checked'; }; ?>>Taxa Fixa
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="tipo_taxa" value="1" <?php if( $data['tipo_taxa'] == 1 ){ echo 'checked'; }; ?>>Cálculo por KM(Valor * km)
                        </div>
                        <div class="clear"></div>
